    ...
    <PageTransition>
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="opacity-75 mt-1 text-sm flex items-center gap-2">
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody>
              ...
              {(!data?.recent?.length) && (
                <tr><td className="py-4 opacity-55 text-sm" colSpan={5}>No pageviews recorded yet.</td></tr>
              )}
            </tbody>
          </table>
        </div>
      ...
      <div className="text-[11px] opacity-50 leading-relaxed">
        Privacy note: no cookies, no third-party trackers. Raw IPs are never stored — only a one-way
        SHA-256 hash (with a server-side salt) used to roughly count unique visitors. Geo is coarse
        country / region / city derived offline. Visitors with Do Not Track enabled aren't recorded.
      </div>
